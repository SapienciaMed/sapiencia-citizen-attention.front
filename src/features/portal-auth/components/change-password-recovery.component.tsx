...
function ChangePasswordRecoveryComponent({ action }): React.JSX.Element {
  // Servicios
    ...
    <main className="container-grid_recoveryPassword">
      ...
      <article className="container-recoveryPassword">
        ...
        <section className="container-form_recoveryPassword">
          ...
          <p className="text-black big not-margin-padding text-center">Por favor ingresa tu nueva contraseña:</p>
          <FormComponent className="form-recoveryPassword" id="form-changePassword" action={onSubmitSignIn}>
            <InputShowPassword
              idInput="password"
...
export default React.memo(ChangePasswordRecoveryComponent);
