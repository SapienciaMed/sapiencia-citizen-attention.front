...
export const TableManagePqrsdfComponent = (props: Props) => {
                ...
                <Link to={""}>
                  ...
                  >
                    <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      />
                      <path
                        d="M12.1215 10.879C13.2935 12.051 13.2935 13.95 12.1215 15.122C10.9495 16.294 9.05051 16.294 7.87851 15.122C6.70651 13.95 6.70651 12.051 7.87851 10.879C9.05051 9.707 10.9505 9.707 12.1215 10.879"
                        stroke="#058CC1"
                        stroke-width="1.4286"
                        stroke-linecap="round"
                        stroke-linejoin="round"
  ...
  const onSubmit = async (data: { justification: string }) => {
    const justification: IReopenRequest = {
      justification: [
        {
      ...
      <div className="flex flex-row items-center justify-between mb-8 header-movil">
        ...
        <div className="flex flex-row items-center tittle-header-movil">
          <div className=" mr-4 flex items-center total">
            ...
            <div>
              <span className="flex items-center bold big text-primary">{dataPqrsdf.length}</span>
            </div>
          </div>
      ...
      <div className="overflow-hidden max-w-[calc(111vw-4.6rem)] sm:max-w-[calc(100vw-10.1rem)] lg:max-w-[calc(100vw-27.75rem)] citizen-attention-paginator block md:block borderless reverse-striped">
        ...
        >
          ...
          <Column
            ...
            header={<p style={{ width: "112px" }}>Doc. Identidad</p>}
          ></Column>
          <Column
            style={{ textAlign: "center" }}
            className="!font-sans"
            field="names"
            header={<p style={{ width: "146px" }}>Nombre y apellidos</p>}
          ></Column>
          <Column
          ...
          <Column
            ...
            className="!font-sans"
            field="fechaRadicado"
            header={<p style={{ width: "124px" }}>Fecha Radicado</p>}
          ></Column>
        ...
        <Card className="card-container">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex justify-center mt-8">
              ...
              ></Button>
              <Button className="rounded-full !h-10" label="Enviar" disabled={!isValid}></Button>
            </div>
          </form>
        </Card>
      </Dialog>
