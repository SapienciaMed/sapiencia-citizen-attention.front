        ...
        <Card className='card card-body'>
            ...
            >
                <div className='mb-8 flex flex-wrap'>
                    <div className='mr-4'>
                        <label className='font-label' style={{color:'black'}}>Canal de atención<span className='required'>*</span></label><br />
                        <Controller
                        name="city"
                        control={control}
                    ...
                    <div>
                        <label className='font-label' style={{color:'black'}}>Elija ¿Cuál?</label><br />
                            <Controller
                            name="city"
                            control={control}
                            render={({ field, fieldState }) => (
                ...
                <p style={{fontSize:'15px'}}
                    className='mb-4'
                >
                    SAPIENCIA adoptó el manual de atención a PQRSDF por resolución 212 de 2016, en virtud de este se establece lo siguiente:
                </p>
                <AccordionComponent/>
            </Card>
